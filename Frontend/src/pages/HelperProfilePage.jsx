                ...
                <div className="rounded-lg bg-[var(--color-bg-component)] p-6 shadow-xl sm:p-8">
                  ...
                  <div className="relative mt-4 aspect-video w-full overflow-hidden rounded-lg">
                    {!showVideo ? (
                      ...
                      <iframe
                        src={helper.introVideo + '?autoplay=1'}
              ...
              <div className="rounded-lg bg-[var(--color-bg-component)] p-6 shadow-xl sm:p-8">
                ...
                <div className="mt-4 flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center">
                      {[...Array(5)].map((_, i) => <Star key={i} className={`h-6 w-6 ${i < Math.round(helper.averageRating) ? 'text-yellow-400' : 'text-slate-300 dark:text-slate-600'}`} fill="currentColor" />)}
                    </div>
                ...
                <div className="mt-8 space-y-8 border-t border-[var(--color-border-subtle)] pt-8">
                  {helper.reviews?.length > 0 ? (
                    helper.reviews.map((review) => (
                      <div key={review._id}>
                        <div className="flex items-center justify-between">
                           {/* Need to populate owner name in backend for this to work */}
                           {/* <p className="font-semibold text-[var(--color-text-strong)]">- {review.owner.fullName}</p> */}
                           <div className="flex items-center">
                    ...
                    <p className="text-center text-[var(--color-text-muted)]">No reviews yet.</p>
                  )}
                </div>
              </div>
            </div>
