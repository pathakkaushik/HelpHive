...
import { Search, UserCheck, CalendarCheck, Star, Briefcase } from 'lucide-react';
  ...
  return (
    <div className="bg-white">
      ...
      <main>
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-40">
                <div className="text-center">
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        <Link to="/find" className="rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Find Help Now
                        </Link>
                        <Link to="/worker-signup" className="text-sm font-semibold leading-6 text-gray-900">
            ...
            <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {services.map((service) => (
                  <div key={service.name} className="flex flex-col items-center rounded-lg border bg-white p-8 text-center shadow-sm">
        ...
        {/* For Professionals CTA Section - NEW */}
            ...
            <div className="mx-auto max-w-4xl px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
                <div className="relative isolate overflow-hidden bg-primary px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        <Link
                            to="/worker-signup"
                            className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-primary shadow-sm hover:bg-indigo-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                        >
